<template>
  <header>
    <div class="logo" @click="redirectToHome" style="cursor: pointer">
      <img id="vue_logo" src="@/assets/logo.png" alt="Logo" />
...
.flexed {
  ...
  gap: 2px; /* Space between h1 and p */
}
...
.flexed p {
  font-size: 0.9rem; /* Adjust font size for subtitle */
  margin: 0;
  padding: 0;
}
